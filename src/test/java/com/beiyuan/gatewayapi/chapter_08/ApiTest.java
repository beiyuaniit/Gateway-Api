...
public class ApiTest {
    ...
    public void test() throws ExecutionException, InterruptedException {
        ...
        //get请求的所有参数要放在请求行上，不然RequestParser解析不到
        //http://localhost:7397/session/test?name=kkk&uid=beiyuan&token=eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJiZWl5dWFuIiwiZXhwIjoxNjg1MjYxMjY0LCJrZXkiOiJra2sifQ.nBXrmzqc4WOqW7fR9NnlNUSr7kv4YhJBxiNuCJ3T9uU
